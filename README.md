...
- **data** : The processed data of four datasets(MovieLens, LLFM360K, BlackFriday, Amazon).
- **model** : The trained model(Wide&Deep, DeepFM, DCN, FGCNN) based on four datasets.
